<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="BenefPolicies.aspx.cs" Inherits="DbmsProjUI.BenefPolicies" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div align="center" style="background-color: #FFFFFF">
<asp:GridView ID="GridViewBenefPolicies" runat="server" CellPadding="4" ForeColor="#333333"
            GridLines="None" AllowSorting="True" AutoGenerateColumns="False" 
            AllowPaging="True" DataKeyNames="PolicyID" 
        onpageindexchanging="GridViewBenefPolicies_PageIndexChanging" 
        onrowcancelingedit="GridViewBenefPolicies_RowCancelingEdit" 
        onrowcommand="GridViewBenefPolicies_RowCommand" 
        onrowdeleting="GridViewBenefPolicies_RowDeleting" 
        onrowediting="GridViewBenefPolicies_RowEditing" 
        onrowupdating="GridViewBenefPolicies_RowUpdating" 
        onsorting="GridViewBenefPolicies_Sorting">
            ...
            <Columns>
                ...
                <ItemTemplate> 
                    <asp:LinkButton ID="linkEnroll" runat="server" CausesValidation="False" CommandName="Enroll" CommandArgument='<%#Eval("PolicyID")%>' Text="Enroll"> </asp:LinkButton> 
                </ItemTemplate> 
            </asp:TemplateField>                
